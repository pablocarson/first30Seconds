...
//			};
	...
	// Stripe Checkout 
		...
		var stripeClientRef = GLOB.first30SecondsRef.child('Stripe/clientEvents');
		// Firebase reference for Stripe to send a pay token after a successful purchase.
		var stripeTokenRef = GLOB.first30SecondsRef.child('Stripe/payTokens');
...
// GLOBAL FUNCTIONS
	...
	// changePage functions
		...
		var globalServerRef = GLOB.first30SecondsRef.child('global/serverEvents');
...
*/
	...
	// Alert functions
		...
		var globalServerAlertRef = GLOB.first30SecondsRef.child('global/alerts');
	...
	// Stripe checkout functions
		...
		var globalServerStripeRef = GLOB.first30SecondsRef.child('Stripe/serverEvents');
	...
	// Geolocation functions
		...
		var globalServerGeoRef = GLOB.first30SecondsRef.child('global/serverEvents/geolocation');	
		var globalClientGeoRef = GLOB.first30SecondsRef.child('global/geolocation');
	...
	var globalClientRef = GLOB.first30SecondsRef.child('global/clientEvents');
...
// HOME PAGE
	...
	var homeServerRef = GLOB.first30SecondsRef.child('pages/home/serverEvents');
	...
	var homeClientRef = GLOB.first30SecondsRef.child('pages/home/clientEvents');
...
// INVITE PAGE
	...
	var inviteServerRef = GLOB.first30SecondsRef.child('pages/invite/serverEvents');
	...
	// Firebase reference for client-generated event messages. 
	var inviteClientRef = GLOB.first30SecondsRef.child('pages/invite/clientEvents');
...
// INTRANSIT PAGE
	...
	var inTransitServerRef = GLOB.first30SecondsRef.child('pages/inTransit/serverEvents')
	...
	// Firebase reference for client-generated event messages. 
	var inTransitClientRef = GLOB.first30SecondsRef.child('pages/inTransit/clientEvents');
...
// ATPARTY PAGE
	...
	var atPartyOtherUserRef = GLOB.first30SecondsRef.child('pages/atParty/otherUser');
	...
	// Firebase reference for client-generated event messages. 
	var atPartyClientRef = GLOB.first30SecondsRef.child('pages/atParty/clientEvents');
...
// RATEOTHERUSER PAGE
	...
	var rateOtherUserServerRef = GLOB.first30SecondsRef.child('pages/rateOtherUser/serverEvents');
	...
	// Firebase reference for client-generated event messages. 
	var rateOtherUserClientRef = GLOB.first30SecondsRef.child('pages/rateOtherUser/clientEvents');
...
// MATCH PAGE
	// Firebase reference for page data for rateOtheruser page
	var matchServerRef = GLOB.first30SecondsRef.child('pages/match/serverEvents');
	...
	// Firebase reference for client-generated event messages. 
	var matchClientRef = GLOB.first30SecondsRef.child('pages/match/clientEvents');
...
// PROFILE PAGE
	// Firebase reference for page data for inTransit page
	var profileServerRef = GLOB.first30SecondsRef.child('pages/profile/serverEvents');
	...
	// Firebase reference for client-generated event messages. 
	var profileClientRef = GLOB.first30SecondsRef.child('pages/profile/clientEvents');
...
// IMAGEUPLOAD PAGE
	...
	var imageUploadServerRef = GLOB.first30SecondsRef.child('pages/imageUpload/serverEvents');
	var imageUploadClientRef = GLOB.first30SecondsRef.child('pages/imageUpload/clientEvents');
